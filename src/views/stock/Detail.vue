  ...
  <div class="stock-detail">
    ...
    <div class="nav-header">
      ...
      <div class="button-container">
        ...
        <button class="new-button" @click="toggleForecastModal">业绩预告</button>
    ...
    <div v-if="isModalOpen" class="modal">
      <div class="modal-content">
        ...
        <div ref="incomeChartRef" style="width: 100%; height: 400px; margin-top: 40px;"></div>
        <div ref="epsChartRef" style="width: 100%; height: 200px; margin-top: 20px;"></div>
        <div ref="taxChartRef" style="width: 100%; height: 200px; margin-top: 20px;"></div>
      </div>
    </div>
    ...
    <div v-if="isForecastModalOpen" class="modal">
      <div class="modal-content">
        ...
        <div ref="forecastChartRef" style="width: 100%; height: 300px; margin-top: 70px;"></div>
        <!-- 新增表格展示业绩预告数据 -->
    ...
    <div v-if="isTop10ModalOpen" class="modal">
      <div class="modal-content">
        ...
        <div ref="top10PieChartRef" style="width: 100%; height: 400px; margin-top: 20px;"></div>
...
export default {
  ...
  setup() {
    ...
    const calculateMACD = (data) => {
      ...
      const dea = calculateEMA(9, dif.map(val => ({ close: val })))
    ...
    const calculateMA = (dayCount, data) => {
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        const sum = data.slice(i - dayCount, i).reduce((sum, item) => sum + item.close, 0)
...
.new-button:hover:before, .new-button:focus:before {
  transition: 0.5s all ease;
  left: 0;
  right: 0;
  opacity: 1;
